...
Author: Ömer Kaşdarma <omer.kasdarma@gmail.com>
Date:   Thu Feb 1 01:22:31 2024 +0300

    fix: checks added for onDidChangeActiveTextEditor &
         onDidChangeTextDocument firing empty events
    fix: repository type added to package.json
    ver: 0.1.1